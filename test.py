...
def main():
    ...
    model = YOLO(
        "/workspace/output/yolov11-2nd/train_session2/weights/best.pt"  # previously "/workspace/output/yolov11/train_session3/weights/best.pt"
    ) # /workspace/output/yolov11-2nd/train_session2

    # Folder containing test images
    input_folder = (
        "/workspace/data/yolov11-Feb11th-dataset/test/images" # "/workspace/data/jam-causing-material-CURRENT.yolov11/test/images"
    )

    # Folder where predictions will be saved
    output_folder = (
        "/workspace/yolo-predictions/predictions-feb-12" # "/workspace/yolo-predictions/predictions-feb-4"
